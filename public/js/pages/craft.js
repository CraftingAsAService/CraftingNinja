...
Vue.component('crafting-zone', __webpack_require__(/*! ../components/CraftingZone.vue */ "./resources/js/components/CraftingZone.vue")["default"]); // Vue.component('crafting-recipe', require('../components/CraftingRecipe.vue').default);
...
var craft = new Vue({
  ...
  computed: _objectSpread({}, _stores_crafting__WEBPACK_IMPORTED_MODULE_0__["getters"], {
    sortedZones: function sortedZones() {
      ...
      var sortedZones = [],
          sortableBreakdown = _.cloneDeep(this.breakdown); // Most likely they were hovering a tooltip; hide it - its moving
      // $('.tooltip').tooltip('hide');


      while (Object.keys(sortableBreakdown).length > 0) {
        // Sort it in reverse by the number of items it has
        var sorted = this.sortZonesBy == 'efficiency' ? Object.entries(sortableBreakdown).sort(function (a, b) {
          if (Object.keys(a[1]).length < Object.keys(b[1]).length) return 1;
          if (Object.keys(a[1]).length > Object.keys(b[1]).length) return -1;
          return 0;
        }) : Object.entries(sortableBreakdown).sort(function (a, b) {
          if (_this.zoneData[a[0]].name < _this.zoneData[b[0]].name) return -1;
          if (_this.zoneData[a[0]].name > _this.zoneData[b[0]].name) return 1;
          return 0;
        ...
        Object.keys(sortableBreakdown).forEach(function (zoneId) {
          ...
          if (Object.keys(sortableBreakdown[zoneId]).length == 0) delete sortableBreakdown[zoneId];
        });
      }
...
/*!*****************************************!*\
  !*** ./resources/js/stores/crafting.js ***!
  \*****************************************/
/*! exports provided: getters, mutations, actions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./resources/js/pages/craft.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/nwright/Projects/Personal/craftingasaservice/crafting.ninja/resources/js/pages/craft.js */"./resources/js/pages/craft.js");
