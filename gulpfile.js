...
gulp.task('watch', function() {
	 ...
	 * JavaScript
	 */
	plugins.saneWatch('resources/assets/js/**/*.js', SANE_OPTIONS, function() {
		gulp.start('js');
	});

	plugins.saneWatch('resources/assets/js/core/**/*.js', SANE_OPTIONS, function() {
		gulp.start('js-core');
	});
});
...
gulp.task('js', function() {
	...
	return gulp.src(['assets/js/**/*.js', '!./assets/js/core/**/*.js'])
		.pipe(plugins.plumber({ errorHandle: plugins.notify.onError("Error: <%= error.message %>") }))
